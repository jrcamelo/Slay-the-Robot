...
@export var action_interceptor_script: Script = null	# script of the BaseActionInterceptor determining behavior of the interceptor
...
@export var action_interceptor_closed_cultivation_allow_self_benefit: bool = false	# for Samurai, positive parent-side damage modifiers must opt in here and still be self-sourced
