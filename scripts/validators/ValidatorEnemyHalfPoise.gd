# Validator for checking whether a single targeted enemy is at or below half poise
extends BaseValidator

func _get_editor_display_name() -> String:
	return "Enemy Half Poise"

func _get_editor_description() -> String:
	return "Checks whether a single targeted enemy has poise at or below half of its maximum."
...
func _validation(_card_data: CardData, action: BaseAction, _values: Dictionary[String, Variant]) -> bool:
	...
	if combatant is Enemy:
		return combatant.is_poise_at_or_below_half()
	return false
