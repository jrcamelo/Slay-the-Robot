...
func _get_editor_display_name() -> String:
	return "Current Planned Stage ID"

func _get_editor_description() -> String:
	return "Checks the planned stage id of the acting enemy."
...
func _get_editor_parameter_definitions() -> Array[Dictionary]:
	...
	parameters.append(_editor_param("stage_id", "Stage ID", "string", "", "Stage id required for the validator to pass."))
	return parameters
...
func _validation(card_data: CardData, action: BaseAction, values: Dictionary[String, Variant]) -> bool:
	...
	return stage_id != "" and combatant.get_planned_stage_id() == stage_id
