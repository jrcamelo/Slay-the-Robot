...
func _get_editor_display_name() -> String:
	return "Adjacent Card Type"

func _get_editor_description() -> String:
	return "Checks whether a card is adjacent to one or more specific card types in hand."
...
func _get_editor_parameter_definitions() -> Array[Dictionary]:
	...
	parameters.append(_editor_param("card_types", "Adjacent Card Types", "enum_array", [], "Adjacent card types that satisfy the validator."))
