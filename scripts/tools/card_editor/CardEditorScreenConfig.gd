...
const LIBRARY_PANEL_MIN_WIDTH := 200
const LIBRARY_PANEL_MAX_WIDTH := 620
const INSPECTOR_PANEL_MIN_WIDTH := 200
const BEHAVIOR_PANEL_MIN_WIDTH := 200
const PREVIEW_PANEL_MIN_WIDTH := 200
const RESPONSIVE_COMPACT_BREAKPOINT := 1300
const RESPONSIVE_TWO_COLUMN_BREAKPOINT := 900
const RESPONSIVE_FOUR_COLUMN_BREAKPOINT := 1500
